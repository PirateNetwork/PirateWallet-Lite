...
QT_CONFIG="$QT_CONFIG -platform linux-g++"
QT_CONFIG="$QT_CONFIG -xplatform win32-g++"
QT_CONFIG="$QT_CONFIG -device-option CROSS_COMPILE=x86_64-w64-mingw32-"
